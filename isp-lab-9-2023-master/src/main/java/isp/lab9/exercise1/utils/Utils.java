...
public class Utils {
  ...
  public static BigDecimal getPercent(BigDecimal numerator, BigDecimal denominator) {
    return denominator != null && numerator != null && denominator.compareTo(BigDecimal.ZERO) != 0
        ? numerator.divide(denominator, 4, RoundingMode.HALF_EVEN).multiply(HUNDRED).setScale(2, RoundingMode.HALF_EVEN)
        : BigDecimal.ZERO;
  }
}
